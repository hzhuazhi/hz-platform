...
public class DateUtil {
    ...
    /**
     * @Description: 获取当前月份最后一天 * @return 格式化的日期
     * @return
     * @author yoko
    ...
    */
	 ...
	 *            date, int days
	 */
	public static Date dateAddDays(String str, int days) throws Exception{
	...
	/**
	 * @Description: TODO(某日期加一年)
	 * @author df
	 * @create 20:02 2018/5/11
	 **/
	public static String getStrAfterday(String str) throws Exception{
...
//		String sb = getDateLongCn(new Date());
//		String sb1 = getWeekOfDate(new Date());
//		System.out.println(sb + " " + sb1);
		String beginTime = "2020-03-04";
		String endTime = "2020-03-05";
		uutOfRangeDate(beginTime, endTime);
		String sb = getDateLong(new Date());
		System.out.println(sb);
		String str = "2020-03-11";
		String sb1 = getStrAfterday(str);
		System.out.println("sb1:" + sb1);

        String sb2 = getFirstDayOfThisMonth();
	...
	/**
	 * @Description: TODO(获取明天的日期，日期格式：2018-05-11)
	 * @author df
	 * @create 20:02 2018/5/11
	 **/
	 ...
	 * @date 2020/3/4 17:54
	*/
	public static boolean uutOfRangeDate(String beginTime, String endTime) throws Exception{
		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");
		Date sd1 = df.parse(beginTime);
		Date sd2 = df.parse(endTime);
//		System.out.println(sd1.before(sd2));// 日期之前
//		System.out.println(sd1.after(sd2));// 日期之后
