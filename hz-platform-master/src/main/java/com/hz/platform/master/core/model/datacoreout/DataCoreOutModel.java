package com.hz.platform.master.core.model.datacoreout;
...
/**
 * @Description 代付订单数据回传:接口上游的数据的实体属性Bean
 * @Author yoko
 * @Date 2020/10/31 21:34
 * @Version 1.0
 */
public class DataCoreOutModel extends BasePage implements Serializable {
    private static final long   serialVersionUID = 1203223401142L;

    public DataCoreOutModel(){
